            ...
            <div class="row">
                ...
                <div class="col-md-3">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('soyte.soyte_ttyte_tramyte_index', ['ttyte'=>$ttyte->ID,'tramyte'=>$item->ID]) }}" class="btn btn-primary">Truy cập vào</a>
                        </div>
    ...
    <div class="col-sm-3">
      <div class="card">
        <div class="card-body">
          ...
          <a href="{{route('benhkhonglayttyte')}}" class="btn btn-primary">Truy cập dữ liệu</a>
        </div>
      </div>
    </div>    
    <div class="col-sm-3">
