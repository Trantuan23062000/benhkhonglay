...
@section('content')
<div>
  <h4>Bạn đăng nhập với quyền sơ y tế</h4>
</div>
  ...
  <div class="collapse" id="collapseExample">
      <div class="card card-body">
          <div class="row">
              ...
              <div class="col-md-4">
                      <h5 class="card-title">{{ $item->TEN_TRUNG_TAM_Y_TE }}</h5>
                      <a href="{{route('soyte.ttyte',$item->ID)}}" class="btn btn-primary">Truy cập vào</a>
              </div>
              @endforeach
          </div>
    ...
    <div class="col-sm-3">
      <div class="card">
        <div class="card-body">
          ...
          <a href="{{route('benhkhonglaysoyte')}}" class="btn btn-primary">Truy cập dữ liệu</a>
        </div>
      </div>
    </div>    
    <div class="col-sm-3">
